...
export default function HousingDetailModal({ housing, onClose, onSuccess }: Props) {
  ...
  const handleReservation = async () => {
    console.log('handleReservation called for housing');
    console.log('housing.id_housing:', housing.id_housing);
    console.log('placesToReserve:', placesToReserve);
    setLoading(true);
    setError(null);
    try {
      const response = await api.post(`/housing/${housing.id_housing}/reservations`, {
        places_reserved: placesToReserve,
      });
      console.log('Housing reservation response:', response);
      setSuccess(true);
      if (onSuccess) {
        onSuccess();
      }
      ...
      console.error('Housing reservation error:', err);
